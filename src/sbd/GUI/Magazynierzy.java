...
public class Magazynierzy extends MainWindow implements Screen {
    ...
    public Magazynierzy(){
        ...
        dataTypes = new String[]{"VARCHAR","VARCHAR","DATE","VARCHAR","NUMBER","DATE","VARCHAR",
                "NUMBER", "VARCHAR"};
        tableName = "MAGAZYNIERZY";
        pK = new String[]{"PESEL"};
        fK = new String[][]{{"NAZWA_MAGAZYNU","MAGAZYNY","NAZWA"}};
        createTable();
    }
