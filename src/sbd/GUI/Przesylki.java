...
public class Przesylki extends MainWindow implements Screen {
    ...
    public Przesylki(){
        ...
        fK = new String[][]{{"PESEL_KURIERA","KURIERZY","PESEL"},{"PESEL_MAGAZYNIERA","MAGAZYNIERZY","PESEL"},{"NAZWA_MAGAZYNU","MAGAZYNY","NAZWA"}};
        createTable();
    }
