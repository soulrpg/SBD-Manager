...
public class Adresy extends MainWindow implements Screen {
    ...
    public Adresy(){
        ...
        dataTypes = new String[]{"ADRES_SEQ", "VARCHAR", "NUMBER", "NUMBER", "VARCHAR", "VARCHAR", "NUMBER"};
        tableName = "ADRESY";
        pK = new String[]{"ID_ADRESU"};
